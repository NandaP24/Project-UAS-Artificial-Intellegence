...
<html lang="en">
<head>
  <title>Input Data Uji Pinus - KNN PINUS </title>
  <meta charset="utf-8">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Cari Data Uji</h4>
      ...
      <div class="modal-body">
        <form method="post">
  <div class="form-group row">
    <label for="sepal_length" class="col-4 col-form-label">Id Data</label> 
    <div class="col-8">
...
if (isset($_POST['submit'])) {
  ...
  $sql="INSERT INTO `datauji`(`Diameter`, `Tinggi`) VALUES ('".$Diameter."','".$Tinggi."')";
