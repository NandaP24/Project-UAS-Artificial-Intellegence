...
<html lang="en">
<head>
  <title>Koreksi Data Training Pinus - KNN PINUS</title>
  <meta charset="utf-8">
...
<div class="container mt-3">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="Jenis" name="Jenis" type="text" class="form-control" required="required" value="<?php echo $r1['Jenis'];?>">
    </div>
  </div> 
  <div class="form-group row">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Cari Data Data Training</h4>
...
if (isset($_POST['submit'])) {
  ...
  $sql="UPDATE `datatraining` SET `Diameter`='".$Diameter."',`Tinggi`='".$Tinggi."',`Jenis`='".$Jenis."' WHERE `IdData`='".$IdData."'";
